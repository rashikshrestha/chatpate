...
def fn_continuous_on():
    ser.write ( b'u' )
    print('u sent')

def fn_continuous_off():
    ser.write ( b'y' )
    print('y sent')
...
Radiobutton(f_B1, text="Direction 1", padx = 30, variable=dirn, command=fn_direction1, value=0).pack(anchor=CENTER)
Radiobutton(f_B1, text="Direction 2", padx = 30, variable=dirn, command=fn_direction2, value=1).pack(anchor=CENTER)
...
Radiobutton(f_B2, text="OFF", padx = 30, variable=continuous_rev, command=fn_continuous_on, value=0).pack(anchor=CENTER)
Radiobutton(f_B2, text="ON", padx = 30, variable=continuous_rev,  command=fn_continuous_off, value=1).pack(anchor=CENTER)
